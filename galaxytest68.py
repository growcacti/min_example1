...
class Expanding_Galaxy:
    surf1 = pg.Surface((6,6))
    surf2 = pg.Surface((6,6))
    surf3 = pg.Surface((6,6))
    surf4 = pg.Surface((6,6))
    surf5 = pg.Surface((6,6))
    surf6 = pg.Surface((6,6))
    surf7 = pg.Surface((6,6))
    surf8 = pg.Surface((6,6))
    surf9 = pg.Surface((6,6))
    surf10 = pg.Surface((6,6))
    surf11 = pg.Surface((6,6))
    surf12 = pg.Surface((6,6))
    surf13 = pg.Surface((6,6))
    surf14 = pg.Surface((6,6))
    surf15 = pg.Surface((6,6))
    surf16 = pg.Surface((6,6))
    surf17 = pg.Surface((6,6))
    surf18 = pg.Surface((6,6))
    surf19 = pg.Surface((6,6))
    
    self.surflist = []
    for i in range(1, 20):
        surflist.append('self.surf%s' % i)
    ...
    def __init__(self, player):
        ...
        for i in range(len(self.starlist)):
            for self.color in self.colorlist:
                ...
                pg.draw.circle(self., self.color, self.pos, self.radius)
                self.starlist.append(self.stars)
    ...
    def bgupdate(self, camx, camy):
         ...
         for self.bg in self.bgdata:
            ...
            screen.blit(self.starlist[0], self.mrect)    
